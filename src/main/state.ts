...
export const ui = {
  ...
  caseTab: 'records' as 'records' | 'list' | 'proof' | 'create',
  ...
  strategyChatError: '',
  strategyRecordEditMessageId: '',
  strategyRecordEditDraft: '',
  strategyMentionOpen: false,
  strategyMentionQuery: '',
  strategyMentionStart: -1,
  strategyMentionEnd: -1,
  strategyMentionSelectedIndex: 0,
  strategyMentionSuggestions: [] as Array<{
    groupId: string,
    memberId: string,
    name: string,
    groupLabel: string,
  }>,
  strategyActionPromptOpen: false,
  strategyActionDraft: '',
  strategyInputGuideOpen: false,
